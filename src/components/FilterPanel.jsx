...
function FilterPanel({ open, onClose, onApply, onClear, filters, setFilters }) {
  ...
  return (
    <>
      ...
      />
      <aside
        className={`filter-panel ${open ? "show" : ""}`}
        role="dialog"
        aria-modal="true"
        aria-labelledby="filterTitle"
      >
        <div className="filter-header">
          <div id="filterTitle" className="fw-bold">
            Filters
          </div>
          <button
        ...
        <div className="filter-body">
          ...
          <section className="border-bottom pb-2 mb-2">
            <button
              className="btn w-100 text-start py-2"
              type="button"
              data-bs-toggle="collapse"
              data-bs-target="#accType"
              aria-expanded="true"
            >
              FRAME TYPE
            </button>
            <div id="accType" className="collapse show">
              <div className="row g-2 row-cols-3">
                {[
                  {
                    val: "Full Rim",
                    img: "https://static.lenskart.com/images/cust_mailer/Eyeglass/FullRim.png",
                  },
                  {
                    val: "Rimless",
                    img: "https://static.lenskart.com/images/cust_mailer/Eyeglass/Rimless.png",
                  },
                  {
                    val: "Half Rim",
                    img: "https://static.lenskart.com/images/cust_mailer/Eyeglass/HalfRim.png",
                  },
                ].map(({ val, img }) => {
                  ...
                  return (
                    <div className="col" key={val}>
                      <label
                        className={`tile w-100 ${selected ? "selected" : ""}`}
                        onClick={() => toggleArrayValue("type", val)}
                        role="checkbox"
                        aria-checked={selected ? "true" : "false"}
                        tabIndex={0}
                        onKeyDown={(e) =>
                          e.key === "Enter" && toggleArrayValue("type", val)
                        }
                      >
                        <img src={img} alt={val} />
                        <span>{val}</span>
                ...
                {[
                  ...
                  return (
                    <span
                      ...
                      onKeyDown={(e) =>
                        e.key === "Enter" && selectPriceRange(label)
                      }
                    >
                      {label}
                    </span>
                  ...
                  return (
                    <div className="col" key={shape}>
                      <label
                        ...
                        tabIndex={0}
                        onKeyDown={(e) =>
                          e.key === "Enter" && toggleArrayValue("shape", shape)
                        }
                      >
                        <span>{shape}</span>
                      </label>
                ...
                {["Small", "Medium", "Large"].map((s) => {
                  ...
                  return (
                    <span
                      ...
                      onKeyDown={(e) =>
                        e.key === "Enter" && toggleArrayValue("size", s)
                      }
                    >
                      {s}
                    </span>
                    ...
                    <div className="col" key={m}>
                      <label className="d-flex align-items-center gap-2">
                        <input
                          ...
                          className="form-check-input"
                          checked={!!selected}
                          onChange={() => toggleArrayValue("material", m)}
                        />
                        <span>{m}</span>
                      </label>
                    </div>
                ...
                {["Lightweight", "Medium", "Heavier"].map((w) => {
                  ...
                  return (
                    <span
                      ...
                      onKeyDown={(e) =>
                        e.key === "Enter" && toggleArrayValue("weight", w)
                      }
                    >
                      {w}
                    </span>
          ...
          <section className="border-bottom pb-2 mb-2">
            <button
              ...
              type="button"
              data-bs-toggle="collapse"
              data-bs-target="#accRx"
            >
              PRESCRIPTION TYPE
            </button>
            <div id="accRx" className="collapse">
              <div className="row g-2 row-cols-2 pt-2">
                {["Single Vision", "Progressive", "Reading", "Non-Power"].map(
                  (t) => {
                      ...
                      <div className="col" key={t}>
                        <label className="d-flex align-items-center gap-2">
                          <input
                            ...
                            className="form-check-input"
                            checked={!!selected}
                            onChange={() => toggleArrayValue("rxType", t)}
                          />
                          <span>{t}</span>
                        </label>
                      </div>
                ...
                {[
                  ...
                  return (
                    <span
                      ...
                      onKeyDown={(e) =>
                        e.key === "Enter" && toggleArrayValue("powers", r)
                      }
                    >
                      {r}
                    </span>
            ...
            <div id="accWidth" className="collapse">
              <div className="d-flex align-items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setFilters((p) => ({ ...p, widthMin: e.target.value }))
                  }
                />
                <span className="text-secondary">to</span>
                <input
                  ...
                  onChange={(e) =>
                    setFilters((p) => ({ ...p, widthMax: e.target.value }))
                  }
                />
              </div>
            </div>
                    ...
                    <div className="col" key={t}>
                      <label className="d-flex align-items-center gap-2">
                        <input
                          ...
                          className="form-check-input"
                          checked={!!selected}
                          onChange={() => toggleArrayValue("prodType", t)}
                        />
                        <span>{t}</span>
                      </label>
                    </div>
                    ...
                    <div className="col" key={c}>
                      <label className="d-flex align-items-center gap-2">
                        <input
                          ...
                          className="form-check-input"
                          checked={!!selected}
                          onChange={() => toggleArrayValue("collection", c)}
                        />
                        <span>{c}</span>
                      </label>
                    </div>
        ...
        <div className="filter-footer">
          ...
          <button className="btn btn-buynow flex-fill" onClick={onApply}>
            Apply Filters
          </button>
        </div>
      </aside>
